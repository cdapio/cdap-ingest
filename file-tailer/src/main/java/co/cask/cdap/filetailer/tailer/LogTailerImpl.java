...
public class LogTailerImpl extends LogTailer {

  private static final Logger LOG = LoggerFactory.getLogger(LogTailerImpl.class);
  ...
  private final byte inbuf[];
    ...
    public LogTailerImpl(FlowConfiguration loader, FileTailerQueue queue,
